...
create_bind("SUPER + SHIFT + S", hl.dsp.exec_cmd('grim -g "$(slurp)" - | wl-copy'))
create_bind("SUPER + SHIFT + T", hl.dsp.exec_cmd("/home/yhvhan/.local/bin/ocr-screenshot.sh"))
create_bind("SUPER + SHIFT + N", hl.dsp.exec_cmd("/home/yhvhan/.local/bin/new-workspace.sh"))
